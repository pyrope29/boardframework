    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="well">
                ...
                <form class="form-horizontal" name="joinForm" action="${root}/member" method="post" onsubmit="return formCheck();">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="validateInfo">* 영문 혹은 영문, 숫자 조합 4자 이상 20자 이하로 작성하세요.</div>
                            <div class="validateInfo validate" id="validateNullId"> 아이디를 입력해 주세요</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="validateInfo">* 이름은 6글자까지 작성 가능합니다.</div>
                            <div class="validateInfo validate" id="validateNullName"> 이름을 입력해 주세요</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                             ...
                             <div class="validateInfo">* 영문 혹은 영문, 숫자 조합 4자 이상 20자 내로 작성하세요.</div>
                             <div class="validateInfo validate" id="validateNullPw"> 비밀번호를 입력해 주세요</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                             ...
                             <div class="validate validateInfo" id="pwCheckDiv">비밀번호가 일치하지 않습니다.</div>
                             <div class="validateInfo validate" id="validateNullPwChk"> 비밀번호가 동일한지 확인해 주세요</div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">생년월일</label>

                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="생년월일 (입력 예: 2000-12-01)" name="bdate" id="bdate">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="전화번호  (입력 예: 010-1234-5678)" name="pnum" id="pnum">
                            </div>
                             <div class="validateInfo">* 필수</div>
                            <div class="validate validateInfo" id="pnumCheckDiv">잘못된 휴대폰 번호입니다. 숫자, - 를 포함한 숫자만 입력하세요.</div>
                            <div class="validate validateInfo" id="validateNullPnumChk"> 전화번호를 입력해 주세요</div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">우편번호</label>

                            <div class="col-lg-6">
                                <input type="text" class="form-control" placeholder="우편번호 (입력 예: 01234)" name="zcode" id="zcode">
                            </div>
